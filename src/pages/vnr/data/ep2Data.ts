...
import { DANGER_STYLE, IMP_STYLE } from "../itemStyle";
...
export const ep2 = [
    ...
    {
        id: "ep2-11",
        content: "Nạn đói cuối năm 1944 đầu năm 1945<br>làm 2 triệu người dân chết đói.",
        start: "1944-12-30",
        style: DANGER_STYLE,
        group: GROUP_ID,
    },
    {
        id: "ep2-12",
        content: "2 vạn quân đội Anh- Ấn đổ bộ vào Sài Gòn<br>(9/1945)",
        start: "1945-09-01",
        group: GROUP_ID,
    },
    {
        id: "ep2-13",
        content: "Hơn 20 vạn quân đội của Tưởng Giới Thạch<br>tràn qua biên giới kéo vào Việt Nam<br>(8/1945)",
        start: "1945-08-30",
        group: GROUP_ID,
    },
    {
        id: "ep2-14",
        content: "Quốc hội khóa I đã họp phiên đầu tiên<br>tại Nhà hát lớn Hà Nội<br>lập ra Chính phủ chính thức<br>(2/3/1946),",
        start: "1946-03-02",
        group: GROUP_ID,
    },
    {
        id: "ep2-15",
        content: "Quân đội Pháp đã nổ súng gây hấn<br>đánh chiếm Sài Gòn-Chợ Lớn<br>(23/9/1945),",
        start: "1945-09-23",
        group: GROUP_ID,
        style: IMP_STYLE
    },
    {
        id: "ep2-16",
        content: "Ban Chấp hành Trung ương Đảng<br>ra Chỉ thị Kháng chiến kiến quốc<br>(25/11/1945),",
        start: "1945-11-25",
        group: GROUP_ID,
    },
    {
        id: "ep2-17",
        content: "Cả nước tham gia cuộc bầu cử<br>có hơn 89% số cử tri đã đi bỏ phiếu<br>dân chủ lần đầu tiên<br>(6/1/1946),",
        start: "1946-01-06",
        group: GROUP_ID,
    },
    {
        id: "ep2-18",
        content: "\"Thông cáo Đảng Cộng sản Đông Dương,<br> tự ý tự giải tán, ngày 11-11-1945\"",
        start: "1945-11-11",
        group: GROUP_ID,
    },
    {
        id: "ep2-19",
        content: "Thường vụ Trung ương Đảng ra<br>bản Chỉ thị Hòa để tiến<br>9/3/1946",
        start: "1946-09-03",
        group: GROUP_ID,
    },
    {
        id: "ep2-20",
        content: "Chủ tịch Hồ Chí Minh đã ký<br>bản Tạm ước 14-9 tại Marseill",
        start: "1946-09-14",
        group: GROUP_ID,
    },
    {
        id: "ep2-21",
        content: "Đại diện Pháp ở Hà Nội đơn phương tuyên bố<br>cắt đứt mọi liên hệ với Chính phủ Việt Nam<br>(18/12/1946)",
        start: "1946-12-18",
        group: GROUP_ID,
    },
    {
        id: "ep2-22",
        content: "Chỉ thị toàn quốc kháng chiến<br>(12/12/1946)",
        start: "1946-12-12",
        group: GROUP_ID,
        style: IMP_STYLE,
    },
    {
        id: "ep2-23",
        content: "Trường Chinh xuất bản tác phẩm<br>Kháng chiến nhất định thắng lợi<br>(8/1947)",
        start: "1947-07-01",
        group: GROUP_ID,
        style: IMP_STYLE,
    },
    // {
    //     id: "ep2-24",
    //     content: "Đảng lao động Việt Nam<br> tuyên bố hoạt động công khai<br",
    //     start: "1947-07-01",
    //     group: GROUP_ID,
    //     style: IMP_STYLE,
    // },
