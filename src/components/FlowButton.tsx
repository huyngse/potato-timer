...
const FlowButton = ({ 
    ...
    const variantClasses = {
      primary: 'bg-gradient-to-br from-blue-400 via-cyan-400 to-teal-400 shadow-blue-500/30 hover:shadow-blue-500/40',
      secondary: 'bg-gradient-to-br from-emerald-400 via-teal-400 to-cyan-400 shadow-emerald-500/30 hover:shadow-emerald-500/40',
      accent: 'bg-gradient-to-br from-violet-400 via-purple-400 to-pink-400 shadow-violet-500/30 hover:shadow-violet-500/40',
